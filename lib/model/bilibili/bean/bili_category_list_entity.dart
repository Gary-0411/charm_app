...
class BiliCategoryListDataItemsUser
    with JsonConvert<BiliCategoryListDataItemsUser> {
  int uid;
...
class BiliCategoryListDataItemsItem
    with JsonConvert<BiliCategoryListDataItemsItem> {
...
class BiliCategoryListDataItemsItemPicture
    with JsonConvert<BiliCategoryListDataItemsItemPicture> {
